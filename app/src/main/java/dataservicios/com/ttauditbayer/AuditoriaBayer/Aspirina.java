            ...
            public void onClick(View v) {
                ...
                if (cbProducto.isChecked()) {
                    ...
                    if(etProducto.getText().equals("")){
                        ...
                        is_recomieda=1;
                        vProducto = 1;
                        oProducto = String.valueOf(poll_id_2) + "aa" + "-" + etProducto.getText().toString();
                ...
                if (cbTienda.isChecked()) {
                    if(cbTienda.getText().equals("")){
                        ...
                        if(cadenaruc.equals("INKAFARMA")){
                            vTienda = 1;
                            oTienda = String.valueOf(poll_id_2) + "h";
                        }
//                    if(cadenaruc.equals("Fasa-Mifarma")){
//                        vTienda = 1;
...
//                    }
                        if(cadenaruc.equals("ARCANGEL")){
                            vTienda = 1;
                            oTienda = String.valueOf(poll_id_2) + "i";
                        }
                ...
                if (cbA.isChecked()) {
                    if(etA.getText().equals("")){
                        ...
                        vA = 1;
                        oA = String.valueOf(poll_id_2) + "k" + "-" + etA.getText().toString();
                    }
                ...
                if (cbB.isChecked()) {
                    if(etB.getText().equals("")){
                        ...
                        vB = 1;
                        oB = String.valueOf(poll_id_2) + "l"  + "-" + etB.getText().toString();
                ...
                if (cbC.isChecked()) {
                    if(etC.getText().equals("")){
                        ...
                        vC = 1;
                        oC = String.valueOf(poll_id_2) + "m" + "-" + etC.getText().toString();
