...
public class Apronax extends Activity {
    ...
    private EditText et_Comentario, et_ComentarioOtros, etComentNoRecomienda, etProducto ,etTienda, etA,etB,etC, etD;
            ...
            public void onClick(View v) {
                ...
                if (cbProducto.isChecked()) {
                    ...
                    if(etProducto.getText().equals("")){
                        ...
                        is_recomieda=1;
                        vProducto = 1;
                        oProducto = String.valueOf(poll_id_2) + "a" + "-" + etProducto.getText().toString();
...
//                }
                ...
                if (cbTienda.isChecked()) {
                    if(cbTienda.getText().equals("")){
                        ...
                        if(cadenaruc.equals("INKAFARMA")){
                            vTienda = 1;
                            oTienda = String.valueOf(poll_id_2) + "b";

                        }
                        if(cadenaruc.equals("Fasa-Mifarma")){
                            vTienda = 1;
                            oTienda = String.valueOf(poll_id_2) + "c";

                        }
                        if(cadenaruc.equals("ARCANGEL")){
                            vTienda = 1;
                            oTienda = String.valueOf(poll_id_2) + "d";
                        }

                        if(cadenaruc.equals("B&S")){
                            vTienda = 1;
                            oTienda = String.valueOf(poll_id_2) + "e";
                        }
                ...
                if (cbA.isChecked()) {
                    if(etA.getText().equals("")){
                        ...
                        vA = 1;
                        oA = String.valueOf(poll_id_2) + "f" + "-" + etA.getText().toString();
                    }
                }
                if (cbB.isChecked()) {
                    if(etB.getText().equals("")){
                        ...
                        vB = 1;
                        oB = String.valueOf(poll_id_2) + "g"  + "-" + etB.getText().toString();
                ...
                if (cbC.isChecked()) {
                    if(etC.getText().equals("")){
                        ...
                        vC = 1;
                        oC = String.valueOf(poll_id_2) + "h" + "-" + etC.getText().toString();
                ...
                totalValores = vProducto + vTienda + vA + vB + vC + vD ;
                totalOption = oProducto + "|" + oTienda + "|" + oA + "|" + oB + "|" + oC + "|" + oD ;
...
//            params.add(new BasicNameValuePair("opcion", options));
//
//            params.add(new BasicNameValuePair("sino", "0"));
//            params.add(new BasicNameValuePair("product", String.valueOf(product_type)));
//
//
